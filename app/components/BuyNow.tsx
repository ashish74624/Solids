...
export default function BuyNow({id,price,firstName,lastName,email,isUser}:any) {
  ...
  return (
    <>
      <button disabled={loading} className={`w-36 md:w-40 h-10 lg:w-48 md:h-12 text-xl md:text-2xl text-white ${loading ? 'bg-gray-500':"bg-gray-800"} rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 `}
