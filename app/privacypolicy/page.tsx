...
export default function page() {
  return (
    <>
     <section className='w-[90vw] mx-auto h-20 bg-white mb-4 text-4xl p-4'>
        Privacy Policy
     </section> 
     <section className='w-[90vw] mx-auto h-max pb-10 bg-white p-4'>
     <>
    ...
    <h2 className="text-2xl">2. How We Collect Information</h2>
    ...
    <ul>
        <li>User Authentication: We use the name and email address for user registration and authentication purposes.</li>
        <li>Communication: We may use the email address to send important updates, order confirmations, and other transaction-related information.</li>
        <li>Personalization: We may use cookies and tracking technologies to personalize the user experience and provide tailored content and recommendations.</li>
    </ul>
    ...
    <ul>
        <li>Third-Party Service Providers: We may share your name and email address with third-party service providers who assist us in delivering our services, such as payment processors or shipping companies. These service providers are contractually bound to protect your information and use it only for the purposes for which it was shared.</li>
        <li>Legal Obligations: We may disclose personal information when required by law or in response to a valid legal request.</li>
    </ul>
