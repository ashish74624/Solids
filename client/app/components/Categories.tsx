    ...
    <section className='h-max w-screen flex flex-col items-center my-4'>
      ...
      <div className='grid grid-cols-2 grid-rows-2 gap-x-4 gap-y-4 mt-4'>
        <div className=" w-96 bg-white border border-gray-200 rounded-sm shadow h-[370px]">
            ...
            <Link href='/men' className=" items-center px-3 py-2 text-base font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-full flex justify-center ">
                Shop Now 
        ...
        <div className="w-96 bg-white border border-gray-200 rounded-sm shadow h-[370px]"> 
            ...
            <Link href='/women' className=" items-center px-3 py-2 text-base font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-full flex justify-center ">
                Shop Now 
                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
        ...
        <div className="w-96 bg-white border border-gray-200 rounded-sm shadow h-[370px]">   
            ...
            <Link href='/jewel' className=" items-center px-3 py-2 text-base font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-full flex justify-center ">
                Shop Now 
                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
